...
const cursorColors = {
  inactive: "rgba(140, 122, 107, 1)",  /* Pastel Brown */
  active: "rgba(178, 211, 194, 1)", /* Pastel Green */
  hoverRing: "rgba(178, 211, 194, 1)", /* Pastel Green */
  clickRing: "rgba(245, 235, 224, 1)", /* Beige */
};
